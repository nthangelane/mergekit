...
def main():
    ...
    while True:
        ...
        # Status update
        print(f"[{timestamp}] Generations: {current_count}/{TARGET_GENS} | Elapsed: {elapsed}m", end="")
        ...
        if current_count > last_count:
            ...
            if latest:
                # Extract key info
                parts = latest.split()
                gen_info = [p for p in parts if 'gen=' in p or 'best=' in p or 'mean=' in p]
        ...
        if current_count >= TARGET_GENS:
            ...
            print("   python plot_ga_results.py workspace/ga_10gen_mac_cpu_run.log --table")
            print("\n2. Generate plot:")
            ...
            print("   grep '[GA]' workspace/ga_10gen_mac_cpu_run.log | wc -l  # New: 10")
            break
