...
# Transformers 5 annotates PretrainedConfig fields with torch types. Pydantic 2.10
# needs that namespace explicitly when these arbitrary-type wrappers are built.
